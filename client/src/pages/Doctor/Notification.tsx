...
import { FaUserPlus, FaClipboardList, FaBell, FaCog, FaUser } from 'react-icons/fa';
...
const NotificationItem: React.FC<NotificationItemProps> = ({ icon, title, subtitle, timeAgo, onView }) => {
    return (
            ...
            <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-900 font-semibold text-lg">KU HealthCare</span>
                    </div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-3">
                        <NotificationItem
                            ...
                            title="New patient appointed: John Doe"
