...
const LabReports: React.FC = () => {
    ...
    const processingCount = labReports.filter(r => r.status === 'processing').length;
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex space-x-6 mb-6">
                        <button
                            ...
                            className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-colors ${activeFilter === 'all'
                        ...
                        <button
                            ...
                            className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-colors ${activeFilter === 'completed'
                        ...
                        <button
                            ...
                            className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-colors ${activeFilter === 'processing'
